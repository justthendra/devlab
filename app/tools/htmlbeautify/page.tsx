...
import HtmlBeautifyTool from "@/components/HtmlBeautifyTool";
...
export default function HtmlBeautifyPage() {
    ...
    return (
        <div className={`min-h-screen w-full flex flex-col items-center px-6 pt-24 pb-12 relative ${theme === "dark" ? "bg-transparent" : "bg-[#f4f7fa]"}`}>
            <title>DevLab - HTML Beautify</title>
            <motion.div
