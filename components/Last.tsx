...
export default function Last() {
  ...
  return (
    <section className={`py-14 flex flex-col items-center text-center ${theme === "dark" ? "bg-transparent" : "bg-transparent"} px-6`}>
  <h3 className={`text-lg font-semibold mb-3 ${theme === "dark" ? "text-slate-300" : "text-slate-700"}`}>Contribute</h3>
